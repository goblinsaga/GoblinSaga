                ...
                <ul>
                  <li>
                    <div className="item">
                      <h4>NFT Price</h4>
                      <div>
                        <h3>11 <img src="/img/POL.png" style={{ width: "20px", marginTop: "-5px" }} /> <span style={{ fontSize: "11px" }}>(Polygon)</span></h3>
                      </div>
                    </div>
                  </li>
                  <li>
            ...
            <div className="mint_right">
              <div className="mright">
                ...
                <div className="mint_checked">
                  ...
                  <div style={{ marginBottom: "10px" }}>
                    <span className="status"><p style={{ color: "#00fc00" }}>Live: 11 <img src="/img/POL.png" style={{ width: "18px", marginTop: "-3px", marginLeft: "3px" }} /></p></span>
                  </div>
                  <p>
