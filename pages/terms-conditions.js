      ...
      <div className="metaportal_fn_privacy">
        <div className="container small">
          <h3
            ...
            data-text="Interpretation and Definitions"
          >
          ...
          <h3 className="fn__maintitle" data-text="Acknowledgment">
            Acknowledgment
          </h3>
          <div className="fn_cs_divider">
            <div className="divider">
          ...
          <h3
            className="fn__maintitle"
            data-text="AS IS and AS AVAILABLE Disclaimer"
          >
          ...
          <h3 className="fn__maintitle" data-text="Severability and Waiver">
          ...
          <h3 className="fn__maintitle" data-text="Translation Interpretation">
          ...
          <h3
            className="fn__maintitle"
            data-text="Changes to These Terms and Conditions"
          >
          ...
          <h3 className="fn__maintitle" data-text="Contact Us">
            Contact Us
          </h3>
          <div className="fn_cs_divider">
            <div className="divider">
