...
const CONTRACT_ADDRESS = '0xac98660b92edf62b9d716bd4978eb0a6231fc052';
const CONTRACT_ABI = [
    "function mintPack() external payable",
    "function packPrice() external view returns (uint256)"
];

const MintPackButton1: React.FC = () => {
...
export default MintPackButton1;
