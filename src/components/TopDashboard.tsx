...
import contractABI from '../../contracts/RewardDistributionABI.json';
                ...
                <div style={{ marginTop: "30px" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <div style={{ display: "flex" }}>
                      ...
                      <button className="metaportal_fn_buttonLW" style={{ margin: "5px" }} onClick={handleDepositMATICRewards}>Deposit $MATIC</button>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ marginTop: "30px" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <div style={{ display: "flex" }}>
                      ...
                      <button className="metaportal_fn_buttonLW" style={{ margin: "5px" }} onClick={handleSetMATICRewards}>Set $MATIC</button>
                    </div>
                  </div>
                </div>
              </div>
